...
export class AuthService {
  ...
  public async register(dto: RegistrationDto): Promise<AuthResponse> {
  ...
  public async signIn(dto: LoginDto): Promise<AuthResponse> {
    const me: User = await this.userService.findOne(dto.username);
    if (!me) {
